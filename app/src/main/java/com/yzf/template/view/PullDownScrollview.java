...
public class PullDownScrollview extends ScrollView {
    ...
    protected void onScrollChanged(int x, int y, int oldx, int oldy) {
        ...
        height = inner.getMeasuredHeight() - mLoadingBottom.getMeasuredHeight() - DisplayUtil.getScreenHeight(getContext())
                + DisplayUtil.dip2px(getContext(), 60);

//        Log.i(">>>>>>>>y", y + "");
//        Log.i(">>>>>>>>getScrollY()", getScrollY() + "");
//        Log.i(">>>>>>>>height", height + "");
//        Log.i(">>>>>>>>ScreenHeight", DisplayUtil.getScreenHeight(getContext()) + "");
//        Log.i(">>>>>>>>60dp", DisplayUtil.dip2px(getContext(), 60) + "");
//        Log.i(">>>>>>>>170dp", DisplayUtil.dip2px(getContext(), 170) + "");
//        Log.i(">>>>>>>>220dp", DisplayUtil.dip2px(getContext(), 220) + "");
//        Log.i(">>>>>>>>135", DisplayUtil.dip2px(getContext(), 135) + "");
//        Log.i(">>>>>>>>inner.getMeasuredHeight()", inner.getMeasuredHeight() + "");
//        Log.i(">>>>>>>>mLoadingBottom.getMeasuredHeight()", mLoadingBottom.getMeasuredHeight() + "");
//        Log.i(">>>>>>>>mLoadingTop.getMeasuredHeight()", mLoadingTop.getMeasuredHeight() + "");
//        Log.i(">>>>>>>>mDetailView.getMeasuredHeight()", mDetailView.getMeasuredHeight() + "");
        //当上拉露出mLoadingView时候 400dp图片的时候  直接滑到底部
        if (y >= height) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (inner == null) {
            ...
            commOnTouchEvent(ev);
            //防止拉取过度的问题
            if (mMoveView.getTop() > DisplayUtil.dip2px(getContext(), 140)
                    && getScrollY() == 0 || mMoveView.getBottom() < inner.getMeasuredHeight()
...
//                        Log.i("+++++++mMoveView.getTop()",mMoveView.getTop()+"");
//                        Log.i("+++++++DisplayUtil.dip2px(getContext(), 245)",DisplayUtil.dip2px(getContext(), 245)+"");
                        RefreshAnimation();
                        //animation();
                        isRefresh = true;
                        listener.onRefresh();
    ...
    public interface ScrollViewListener {
        void onScrollChanged(PullDownScrollview scrollView, int x, int y, int oldx, int oldy);
    }
